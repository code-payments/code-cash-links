...
export class GetLimitsResponse extends Message<GetLimitsResponse> {
   ...
   * Deposit limits
   *
   * @generated from field: code.transaction.v2.DepositLimits deposit_limits = 3;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "deposit_limits", kind: "message", T: DepositLimits },
  ]);
...
/**
 * @generated from message code.transaction.v2.DepositLimits
 */
export class DepositLimits extends Message<DepositLimits> {
  /**
  ...
  constructor(data?: PartialMessage<DepositLimits>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "code.transaction.v2.DepositLimits";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "max_quarks", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DepositLimits {
    return new DepositLimits().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DepositLimits {
    return new DepositLimits().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DepositLimits {
    return new DepositLimits().fromJsonString(jsonString, options);
  }

  static equals(a: DepositLimits | PlainMessage<DepositLimits> | undefined, b: DepositLimits | PlainMessage<DepositLimits> | undefined): boolean {
    return proto3.util.equals(DepositLimits, a, b);
  }
}
